...
class ContinuousTracking:
    ...
    without data loss.
    """
    def __init__(self, video_path, output_dir, tracker_config_path, save_interval = 5000, model_name = "yolov9e.pt", conf=0.05, iou=0.45, imgsz = 1920, print_current_frame = True, focus_ids = None):
        ...
        self.focus_ids = focus_ids if focus_ids is not None else []
